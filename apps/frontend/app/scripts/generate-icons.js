 ...
 * generate-icons.js
 *
 * Generates customer-specific app icons into ./assets/generated/ by calling
 ...
 *    warning so that `yarn install` is not broken.
 */
...
// The app root is one level above this script (apps/frontend/app/)
...
try {
	...
	// config.ts lives one level above this script (apps/frontend/app/config.ts)
...
console.log('[generate-icons] Generating customer icons...');
