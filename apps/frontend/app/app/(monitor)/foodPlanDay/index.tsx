			...
			>
				<View style={styles.settingContainer}>
					...
					<SettingsList
						...
						label={translate(TranslationKeys.food_offer_category_optional)}
					...
					<SettingsListBoolean
						...
						label={translate(TranslationKeys.show_food_offer_category_name)}
					...
					<SettingsListBoolean
						...
						label={translate(TranslationKeys.full_screen)}
