...
// getCustomer.ts is generated by scripts/generateCustomer.sh in CI and provides a reliable
// fallback when the env variables are not set correctly.
function getCustomerFromGeneratedFile(): string | undefined {
	try {
...
export function getCustomerEnvVariable(): string | undefined {
	return process.env.EXPO_PUBLIC_CUSTOMER || process.env.CUSTOMER || getCustomerFromGeneratedFile();
}
