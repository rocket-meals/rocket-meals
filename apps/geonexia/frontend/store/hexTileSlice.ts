...
import { HexTileRecord, HexTileBillboardFields, BillboardAnchorPosition, computeHexTileLevel } from '../helpers/HexTileStorage';
 ...
 */
export type HexTileCustomizationPayload = HexTileBillboardFields;
