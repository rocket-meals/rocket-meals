...
export type ReportEntryLabelBaseType = {
...
export type ReportFoodEntryLabelType = ReportEntryLabelBaseType & {
  id: string;
  alias: string;
};
...
export type ReportCanteenEntryLabelsType = ReportEntryLabelBaseType & {
  label_alias: string;
};
